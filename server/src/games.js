...
const castlevaniaSymphonyOfTheNight = {
  details: {
...
const chronoTrigger = {
  ...
  songs: [
    {
      name: 'Presentiment',
      url: 'https://www.youtube.com/watch?v=Ja0saZrHkXk'
    },
    {
      name: 'Chrono Trigger',
      url: 'https://www.youtube.com/watch?v=wR91d9itVZ4'
    },
    {
      name: 'Morning Sunlight',
      url: 'https://www.youtube.com/watch?v=Tmc0fFzIzKk'
    },
    {
      name: 'Wind Scene',
      url: 'https://www.youtube.com/watch?v=iN4TSrFHyRg'
    },
    {
      name: "Frog's Theme",
...
const darkSouls = {
  ...
  songs: [
    {
      name: 'Bell Gargoyle',
      url: 'https://www.youtube.com/watch?v=ac8QTcY0G0E'
    },
    {
      name: 'Great Grey Wolf Silf',
  ...
  songs: [
    {
      ...
      url: 'https://www.youtube.com/watch?v=cBWmvxc4L5I'
    },
    {
      name: 'A Corner of Memories',
      url: 'https://www.youtube.com/watch?v=iV1o6tbZLZk'
    },
    {
      name: 'Your Affection',
      url: 'https://www.youtube.com/watch?v=d-x3ojOGWa8'
    },
    {
      name: "I'll Face Myself",
      url: 'https://www.youtube.com/watch?v=rV4BlAlrIlk'
    },
    {
      name: 'Heartbeat, Heartbreak',
      url: 'https://www.youtube.com/watch?v=ZGyVct4wi2E'
    }
  ]
}
...
const superMario64 = {
  ...
  songs: [
    {
      name: 'Title Theme',
      url: 'https://www.youtube.com/watch?v=pYAjvWCVkH0'
    },
    {
...
const theLegendOfZeldaOcarinaOfTime = {
  details: {
...
const undertale = {
  details: { title: 'Undertale', composer: 'Toby Fox' },
  songs: [
    {
      name: 'Once Upon a Time',
      url: 'https://www.youtube.com/watch?v=s7RRgF5Ve_E'
    },
    {
      name: 'Hopes and Dreams',
      url: 'https://www.youtube.com/watch?v=tz82xbLvK_k'
    },
    {
      name: 'Snowy',
      url: 'https://www.youtube.com/watch?v=8BIeGdBjJiU'
    },
    {
      name: 'Megalovania',
